     ...
     */
     ...
     'adminStatusOnChannelComm' => [
          'PL' => [
               ...
               'availableCommands' => 'Dostępne komendy to:',
               'command1' => '[b]!adminStatusOnChannel add <clientDatabaseId> <channelId>[/b]            |    [i](Dodajemy wpis)[/i]',
               'command2' => '[b]!adminStatusOnChannel remove <clientDatabaseId> <channelId>[/b]     |    [i](Usuwamy wpis)[/i]',
          ...
          'EN' => [
               ...
               'availableCommands' => 'Available commands:',
               'command1' => '[b]!adminStatusOnChannel add <clientDatabaseId> <channelId>[/b]            |    [i](Adding entry)[/i]',
               'command2' => '[b]!adminStatusOnChannel remove <clientDatabaseId> <channelId>[/b]     |    [i](Removing entry)[/i]',
