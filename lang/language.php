     ...
     */
     ...
     'adminStatusOnChannelComm' => [
          'PL' => [
               ...
               'notExistingEntry' => 'Nie ma takiego wpisu!',
               'listOfEntries' => 'Lista wpisów:',
               'entryInfo' => '   ID kanału: [b][channel] [/b]przypisany do dbid: [b][dbid] [/b]',
               'availableCommands' => 'Dostępne komendy to:',
               'command1' => '[b]!adminStatusOnChannel add <channelId> <clientDatabaseId>[/b]            |    [i](Dodajemy wpis)[/i]',
               'command2' => '[b]!adminStatusOnChannel remove <channelId> <clientDatabaseId>[/b]     |    [i](Usuwamy wpis)[/i]',
          ...
          'EN' => [
               ...
               'notExistingEntry' => 'Incorrect entry!',
               'listOfEntries' => 'List of entries:',
               'entryInfo' => '   Channel ID: [b][channel] [/b]assigned to dbid: [b][dbid] [/b]',
               'availableCommands' => 'Available commands:',
               'command1' => '[b]!adminStatusOnChannel add <channelId> <clientDatabaseId>[/b]            |    [i](Adding entry)[/i]',
               'command2' => '[b]!adminStatusOnChannel remove <channelId> <clientDatabaseId>[/b]     |    [i](Removing entry)[/i]',
